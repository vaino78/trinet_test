...
$MESS['TRINET_TEST_CATALOG_IBLOCK_IS_NOT_SET']      = 'Не выбран каталог для работы';
$MESS['TRINET_TEST_SECTION_UPDATE_TAB']             = 'Общие';
$MESS['TRINET_TEST_SECTION_UPDATE_TITLE']           = 'Изменение цен товаров по секциям';
